...
After the IC engine placement, a 12S 16000 mAh battery and a 6 L fuel tank were placed inside the fuselage. The fuel tank was centered on the CG so that the CG does not shift significantly with fuel burn during flight. This section is covered by the mid fuselage fairing.
