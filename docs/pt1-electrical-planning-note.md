...
- The architecture moved substantially between June 11 and June 17 (FC 6X to 6C, battery ProFuse 16 Ah to motorobit 22 Ah, regulators to PM12S-3 + buck, GPS to serial F9P primary, HV kill to software-only). This note reflects the June 17 state at SPH-E-001 Rev 0.18. The June 18 RC/telemetry close (Radiolink AT9S Pro RC on SBUS, STORK-borrowed Holybro SiK V3 telemetry for first flight) is a part selection within the existing "short-range RF link only" framing above, not a change to it; see SPH-E-002 (D3) and SPH-E-001 §4.12.
